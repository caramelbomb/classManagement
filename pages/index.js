          ...
          <div class='md:flex md:items-center mb-6'>
            ...
            <div class='md:w-2/3'>
              <input
                ...
                class='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500' id='inline-password' type='text' placeholder='ห้อง'
              />
            </div>
          </div>
          <div class='md:flex md:items-center mb-6'>
            ...
            <div class='md:w-2/3'>
              <input
                ...
                class='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500' id='inline-password' type='text' placeholder='เวลาเริ่ม'
              />
            </div>
          </div>
          <div class='md:flex md:items-center mb-6'>
            ...
            <div class='md:w-2/3'>
              <input
                ...
                class='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500' id='inline-password' type='text' placeholder='เวลาจบ'
              />
            </div>
          </div>
